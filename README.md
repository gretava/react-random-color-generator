...
- [ ] A button with the exact text Generate will cause a new color to be generated when it is clicked:
  - [ ] Create a button with text 'Generate'
  - [ ] When clicked, it generates random color
  - [ ] Update the background color of a div which contains the exact text Generated Color: <background color hex code>
        Design the web app:
- [ ] Button design
